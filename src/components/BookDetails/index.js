    ...
    return (
      <BookshelvesContext.Consumer>
        {value => {
          ...
          return (
            <div className={`book-Details-Container ${themeMode && 'bgDark'}`}>
              <div className={`book-Details-Box ${themeMode && 'boxBgDark'}`}>
                <div className="img-Details">
                  <img className="details-Image" alt={title} src={coverPic} />
                  <div className="details-Container">
                    ...
                    <p
                      className={`details-Author ${themeMode && 'colorWhite'}`}
                    >
                      {authorName}
                    </p>
                    <p
                      className={`details-Rating ${themeMode && 'colorWhite'}`}
                    >
                    ...
                    <p
                      className={`details-Status ${themeMode && 'colorWhite'}`}
                    >
                      Status:
                ...
                <hr />
                <div>
                  <h1 className={`about-Heading ${themeMode && 'colorWhite'}`}>
                    About Author
                  </h1>
                  <p className={`about-Author ${themeMode && 'colorWhite'}`}>
                    {aboutAuthor}
                  </p>
                </div>
                <div className="about-Container">
                  ...
                  <p className={`about-Book ${themeMode && 'colorWhite'}`}>
                    {aboutBook}
                  </p>
                </div>
              </div>
  ...
  renderFailureView = () => (
    <BookshelvesContext.Consumer>
      {value => {
        ...
        return (
          <div className={`details-Failure-View ${themeMode && 'bgDark'}`}>
            <img
              className="details-Failure-Image"
              alt="failure view"
              src="https://res.cloudinary.com/dgonqoet4/image/upload/v1686887648/somethingwrong_l7pyto.png"
            />
            <p className="details-Failure-Heading">
